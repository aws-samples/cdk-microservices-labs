...
class ServerlessLambdaStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        table = _dynamodb.Table(self, 'VetTable',
        ...
        resource = _cfn.CustomResource(self, "VetDataImportCustomResource",
        ...
        base_lambda = _lambda.Function(self,'ApiPetclinicVetLambda',
            handler='org.springframework.samples.petclinic.vets.StreamLambdaHandler::handleRequest',
            runtime=_lambda.Runtime.JAVA_8,
            code=self.lambda_code,
            memory_size=1024,
            timeout=core.Duration.seconds(300),
            initial_policy=lambda_policies,
            environment={"DYNAMODB_TABLE_NAME":table.table_name, "SERVER_SERVLET_CONTEXT_PATH":"/api/vet"}
        )
